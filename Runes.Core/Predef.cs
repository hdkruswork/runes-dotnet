...
namespace Runes
{
    public static class Predef
    {
        ...
        public static sbyte Max(params sbyte[] values) => Max(OrderingBy<sbyte>(), sbyte.MinValue, values);
        public static sbyte Min(params sbyte[] values) => Min(OrderingBy<sbyte>(), sbyte.MaxValue, values);
        public static sbyte Max(this IIterable<sbyte> values) => Max(values, OrderingBy<sbyte>(), sbyte.MinValue);
        public static sbyte Min(this IIterable<sbyte> values) => Min(values, OrderingBy<sbyte>(), sbyte.MaxValue);
        public static byte Max(params byte[] values) => Max(OrderingBy<byte>(), byte.MinValue, values);
        public static byte Min(params byte[] values) => Min(OrderingBy<byte>(), byte.MaxValue, values);
        public static byte Max(this IIterable<byte> values) => Max(values, OrderingBy<byte>(), byte.MinValue);
        public static byte Min(this IIterable<byte> values) => Min(values, OrderingBy<byte>(), byte.MaxValue);
        public static short Max(params short[] values) => Max(OrderingBy<short>(), short.MinValue, values);
        public static short Min(params short[] values) => Min(OrderingBy<short>(), short.MaxValue, values);
        public static short Max(this IIterable<short> values) => Max(values, OrderingBy<short>(), short.MinValue);
        public static short Min(this IIterable<short> values) => Min(values, OrderingBy<short>(), short.MaxValue);
        public static ushort Max(params ushort[] values) => Max(OrderingBy<ushort>(), ushort.MinValue, values);
        public static ushort Min(params ushort[] values) => Min(OrderingBy<ushort>(), ushort.MaxValue, values);
        public static ushort Max(this IIterable<ushort> values) => Max(values, OrderingBy<ushort>(), ushort.MinValue);
        public static ushort Min(this IIterable<ushort> values) => Min(values, OrderingBy<ushort>(), ushort.MaxValue);
        public static int Max(params int[] values) => Max(OrderingBy<int>(), int.MinValue, values);
        public static int Min(params int[] values) => Min(OrderingBy<int>(), int.MaxValue, values);
        public static int Max(this IIterable<int> values) => Max(values, OrderingBy<int>(), int.MinValue);
        public static int Min(this IIterable<int> values) => Min(values, OrderingBy<int>(), int.MaxValue);
        public static uint Max(params uint[] values) => Max(OrderingBy<uint>(), uint.MinValue, values);
        public static uint Min(params uint[] values) => Min(OrderingBy<uint>(), uint.MaxValue, values);
        ...
        public static long Max(params long[] values) => Max(OrderingBy<long>(), long.MinValue, values);
        public static long Min(params long[] values) => Min(OrderingBy<long>(), long.MaxValue, values);
        ...
        public static ulong Max(params ulong[] values) => Max(OrderingBy<ulong>(), ulong.MinValue, values);
        public static ulong Min(params ulong[] values) => Min(OrderingBy<ulong>(), ulong.MaxValue, values);
        ...
        public static float Max(params float[] values) => Max(OrderingBy<float>(), float.MinValue, values);
        public static float Min(params float[] values) => Min(OrderingBy<float>(), float.MaxValue, values);
        ...
        public static double Max(params double[] values) => Max(OrderingBy<double>(), double.MinValue, values);
        public static double Min(params double[] values) => Min(OrderingBy<double>(), double.MaxValue, values);
        public static double Max(this IIterable<double> values) => Max(values, OrderingBy<double>(), double.MinValue);
        public static double Min(this IIterable<double> values) => Min(values, OrderingBy<double>(), double.MaxValue);
        public static decimal Max(params decimal[] values) => Max(OrderingBy<decimal>(), decimal.MinValue, values);
        public static decimal Min(params decimal[] values) => Min(OrderingBy<decimal>(), decimal.MaxValue, values);
        public static decimal Max(this IIterable<decimal> values) => Max(values, OrderingBy<decimal>(), decimal.MinValue);
        public static decimal Min(this IIterable<decimal> values) => Min(values, OrderingBy<decimal>(), decimal.MaxValue);
        ...
        public static TimeInterval Milliseconds(this int value) => TimeInterval.FromMilliseconds(value);
        public static TimeInterval Milliseconds(this long value) => TimeInterval.FromMilliseconds(value);
        public static TimeInterval Milliseconds(this Int value) => TimeInterval.FromMilliseconds(value);
